...
external fun config(options: DotenvOptions = definedExternally): DotenvResult;
...
external interface DotenvResult {
    ...
    var parsed: dynamic get() = definedExternally; set(value) = definedExternally
}
